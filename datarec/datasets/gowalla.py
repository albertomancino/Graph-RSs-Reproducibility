...
class Gowalla(DataRec):
    ...
    train_url = ('https://raw.githubusercontent.com/xiangwang1223/neural_graph_collaborative_filtering/'
                 'master/Data/gowalla/train.txt')
    test_url = ('https://raw.githubusercontent.com/xiangwang1223/neural_graph_collaborative_filtering/'
                 'master/Data/gowalla/test.txt')
    user_list = ('https://raw.githubusercontent.com/xiangwang1223/neural_graph_collaborative_filtering/'
                 'master/Data/gowalla/user_list.txt')
    item_list = ('https://raw.githubusercontent.com/xiangwang1223/neural_graph_collaborative_filtering/'
                 'master/Data/gowalla/item_list.txt')

    def __init__(self, download=False, folder=None):
