...
def amazon_book_preprocessing():
    ...
    train_path = os.path.join(dataset_raw_directory(AMAZON), train_name)
    test_path = os.path.join(dataset_raw_directory(AMAZON), test_name)
...
def gowalla_preprocessing():
    ...
    train_path = os.path.join(dataset_raw_directory(GOWALLA), train_name)
    test_path = os.path.join(dataset_raw_directory(GOWALLA), test_name)
...
def yelp_preprocessing():
    ...
    train_path = os.path.join(dataset_raw_directory(YELP), train_name)
    test_path = os.path.join(dataset_raw_directory(YELP), test_name)
